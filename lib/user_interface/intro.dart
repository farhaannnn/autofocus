  ...
  Widget build(BuildContext context) {
    ...
    Container(
       decoration: const BoxDecoration(
        image: DecorationImage(image: AssetImage('assets/1a6a58f1c30d8bb8ae2e4f5d324c12b2.jpg'),
        fit: BoxFit.fill)
      ),
          ...
          child: Column(
            children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.end,  children: [
                ...
                style: ElevatedButton.styleFrom(minimumSize: const Size.square(50),    backgroundColor: Color.fromARGB(255, 249, 224, 3),
